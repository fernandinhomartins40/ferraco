...
// Mock screen, waitFor, and fireEvent from @testing-library/dom
const screen = {
  queryByTestId: vi.fn(),
  getByTestId: vi.fn(),
  getByText: vi.fn(),
...
// Mock Login component (deleted)
const Login = () => React.createElement('div', { 'data-testid': 'login-page' }, 'Login Page');

// Mock AuthProvider (deleted - using useAuth stub instead)
const AuthProvider = ({ children }: { children: React.ReactNode }) => React.createElement('div', null, children);
